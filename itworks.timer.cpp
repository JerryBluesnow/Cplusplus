...
void create_stat(acl_list_container& table)
{
    ...
    for (UINT y = 0; y < 500; y++)
    {
        for (UINT i = 0; i < 100;)
        {
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 0), 010, 119, 1200, 1400, 0)); 
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 1), 010, 119, 1000, 1200, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 2), 010, 119, 1400, 1600, 0));

            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 3), 120, 140, 1200, 1400, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 4), 120, 140, 1000, 1200, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 5), 120, 140, 1400, 1600, 0));

            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 6), 100, 120, 1200, 1401, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 7), 100, 120, 1000, 1200, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 8), 100, 120, 1400, 1600, 0));

            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 9), 121, 140, 1200, 1400, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 10), 121, 140, 1000, 1200, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 11), 121, 140, 1400, 1600, 0));

            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 12), 119, 125, 1200, 1402, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 13), 119, 125, 1000, 1200, 0));
            table.insert(acl_list_db(ACL_TBL_KEY(y, i + 14), 119, 125, 1400, 1600, 0));
...
void select_stat(acl_list_container& table)
{
...

    {
        ...
        ppp = itbl_key_index.range(ACL_TBL_KEY(21,0) <= boost::lambda::_1, boost::lambda::_1 <= ACL_TBL_KEY(21,40960));
