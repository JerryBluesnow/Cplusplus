...
void test_insert()  
{
    ...
    acl->insert(new acl_list_db(174015000, range_index<unsigned int>(250, 255), range_index<unsigned int>(0, 1239), acl_list_attributes(), 3));
    acl->insert(new acl_list_db(174015000, range_index<unsigned int>(250, 255), range_index<unsigned int>(1, 2490), acl_list_attributes(), 4));
    acl->insert(new acl_list_db(174015000, range_index<unsigned int>(250, 255), range_index<unsigned int>(2490, 2500), acl_list_attributes(), 5));
    acl->print(); 
}
...
test_search()
{
    ...
    while (1)
    {
        ...
        cout << "Please input prefix(prefix 999999 means break):";
        ...
        acl->find(acl_list_address_index(prefix, range_index<unsigned int>(ip, ip),
                                         range_index<unsigned int>(port, port)));
    }
    return;
}
