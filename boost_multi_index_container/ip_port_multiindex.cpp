...
void test1()  
{
    ...
    acl->insert(new acl_list_db(172018000, range_index<unsigned int>(1, 5), range_index<unsigned int>(1230, 1240), acl_list_attributes(), 1));
    acl->insert(new acl_list_db(172018000, range_index<unsigned int>(0, 3), range_index<unsigned int>(1250, 1260), acl_list_attributes(), 2)); 
    acl->insert(new acl_list_db(172018000, range_index<unsigned int>(4, 8), range_index<unsigned int>(2000, 4000), acl_list_attributes(), 1721));
    acl->print(); 
}  
...
int main()  
{
    ...
    acl->find(acl_list_address_index(172018000, range_index<unsigned int>(1, 5), range_index<unsigned int>(1230, 1240)), 1);
    acl->find(acl_list_address_index(172018000, range_index<unsigned int>(1, 5), range_index<unsigned int>(1230, 1240)));
    cout << "try to find......" << endl;    
    acl->find(acl_list_address_index(172018000, range_index<unsigned int>(0, 3), range_index<unsigned int>(1250, 1260)), 2);
    acl->find(acl_list_address_index(172018000, range_index<unsigned int>(0, 3), range_index<unsigned int>(1250, 1260)));
    cout << "try to find......" << endl;    
    acl->find(acl_list_address_index(172018000, range_index<unsigned int>(4, 8), range_index<unsigned int>(2000, 4000)), 1722);
    acl->find(acl_list_address_index(172018000, range_index<unsigned int>(4, 8), range_index<unsigned int>(2000, 4000)));

    cout << "try to erase......" << endl;    
    acl->erase(acl_list_address_index(172018000, range_index<unsigned int>(0, 3), range_index<unsigned int>(1250, 1260)), 2);
    ...
    cout << "try to erase......" << endl;    
    acl->erase(acl_list_address_index(172018000, range_index<unsigned int>(1, 5), range_index<unsigned int>(1230, 1240)), 10);
