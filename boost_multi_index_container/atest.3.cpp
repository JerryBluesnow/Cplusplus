...
void find(acl_list_address_index my_index)  
{  
...
void find(acl_list_address_index my_index, unsigned int my_id) 
{
...
void test1()  
{
    ...
    mycontainer.insert(a);  
    //print_container<Index_X_Tag>(mycontainer);    
}  
...
int main()  
{
     ...
     print_container<Index_X_Tag>(mycontainer);
     // cout<<endl;
     // print_container<Index_XY_Tag>(mycontainer);
     // cout<<endl;
